...
Cloud services are not named with deployment detail. Airflow or Prefect orchestration is not shown yet.""",
        ...
        "skills_analysis": {
            "matched_skills": [
                {"skill": "Python", "category": "Programming", "evidence_status": "Supported", "resume_evidence": "Fraud analytics and Kafka pipeline projects."},
                {"skill": "SQL", "category": "Data Engineering", "evidence_status": "Supported", "resume_evidence": "SQL transformations and PostgreSQL loading."},
                {"skill": "Kafka", "category": "Streaming", "evidence_status": "Supported", "resume_evidence": "Real-time transaction streaming pipeline."},
                {"skill": "PostgreSQL", "category": "Data Storage", "evidence_status": "Supported", "resume_evidence": "Fraud analytics and streaming storage."},
                {"skill": "Docker", "category": "DevOps", "evidence_status": "Supported", "resume_evidence": "Containerized pipeline and monitoring services."},
            ],
            "missing_skills": [
                {"skill": "Airflow or Prefect", "category": "Orchestration", "priority": "Would help", "reason": "Schedule the streaming or fraud pipeline with retries and dependency checks."},
                {"skill": "Named cloud services", "category": "Cloud", "priority": "Would help", "reason": "Deploy one project to AWS, Azure, or GCP and cite the services."},
                {"skill": "Data quality framework", "category": "Data Quality", "priority": "Nice to have", "reason": "Add validation checks with Great Expectations or dbt tests."},
            ],
            "nice_to_have_skills": [
                {"skill": "dbt", "category": "Data Transformation", "status": "Missing", "resume_evidence": "Not shown; useful for SQL transformation workflows."},
                {"skill": "Terraform", "category": "Infrastructure", "status": "Missing", "resume_evidence": "Not shown; useful for cloud infrastructure evidence."},
            ],
        },
        ...
        "score_drivers": [
            {"driver": "Technical skills", "contribution": 28, "direction": "Positive", "evidence": "Python, SQL, Kafka, PostgreSQL, Docker, and dashboarding are directly supported."},
            {"driver": "ATS keywords", "contribution": 22, "direction": "Positive", "evidence": "Core JD terms such as Python, SQL, Kafka, and dashboarding are covered."},
            {"driver": "Experience fit", "contribution": 16, "direction": "Positive", "evidence": "Projects show pipeline, streaming, and monitoring work aligned to data engineering."},
            {"driver": "Cloud proof gap", "contribution": -8, "direction": "Negative", "evidence": "Named AWS, Azure, or GCP services are not present in the resume evidence."},
            {"driver": "Orchestration gap", "contribution": -6, "direction": "Negative", "evidence": "Airflow, Prefect, or scheduler evidence is not found in the supplied projects."},
        ],
        "confidence_findings": [
            {
                "finding": "Python, SQL, Kafka, PostgreSQL, and Docker are strongly supported.",
                "confidence": "High",
                "resume_evidence": "Fraud analytics, streaming pipeline, and monitoring projects list these tools directly.",
                "jd_evidence": "The sample JD expects data pipelines, SQL transformations, streaming, and operational workflows.",
                "risk": "Low",
                "recommendation": "Keep these skills visible in the summary, skills section, and project bullets.",
                "verify_manually": "Confirm each tool appears in the final resume text submitted for the role.",
            },
            {
                "finding": "Cloud deployment evidence is incomplete.",
                "confidence": "High",
                "resume_evidence": "Not found in resume. Docker and distributed services are present, but named cloud services are not shown.",
                "jd_evidence": "The sample JD expects scalable data pipelines on cloud infrastructure.",
                "risk": "Medium",
                "recommendation": "Add a cloud-hosted project detail only if it is true.",
                "verify_manually": "Check whether any project actually used AWS, Azure, or GCP before adding cloud claims.",
            },
            {
                "finding": "Workflow orchestration is a likely gap.",
                "confidence": "Medium",
                "resume_evidence": "Not found in resume. No Airflow, Prefect, or scheduler is listed.",
                "jd_evidence": "The sample JD includes scheduled workloads and dependency management.",
                "risk": "Medium",
                "recommendation": "Build or document a small orchestration layer for one existing pipeline.",
                "verify_manually": "Confirm whether a scheduler was used but omitted from the project description.",
            },
        ],
        "fix_impact_matrix": [
            {"fix": "Add named cloud deployment proof", "impact": "High", "effort": "Medium", "priority": "Important", "why_it_matters": "Cloud ownership is the clearest proof gap for this role.", "source": "Requirement"},
            {"fix": "Add metrics to the strongest project bullets", "impact": "High", "effort": "Low", "priority": "Important", "why_it_matters": "Measurable outcomes make the resume easier to trust and compare.", "source": "Resume Fix"},
            {"fix": "Build an Airflow or Prefect orchestration layer", "impact": "Medium", "effort": "Medium", "priority": "Would help", "why_it_matters": "Scheduling, retries, and dependency handling signal production readiness.", "source": "Skill Gap"},
            {"fix": "Add project dates or portfolio labels", "impact": "Medium", "effort": "Low", "priority": "Would help", "why_it_matters": "Timeline clarity helps reviewers understand recency and scope.", "source": "Resume Fix"},
            {"fix": "Add data quality checks to one pipeline", "impact": "Medium", "effort": "Medium", "priority": "Nice to have", "why_it_matters": "Validation checks strengthen the reliability story.", "source": "Skill Gap"},
        ],
        "eligibility_risks": [],
        "evidence_based_matches": [
            {"jd_requirement": "Real-time data processing", "match_strength": "Strong", "explanation": "The Kafka transaction pipeline directly supports this requirement.", "resume_evidence": "Kafka producers/consumers, event validation, rejected-record handling."},
            {"jd_requirement": "Analytical reporting", "match_strength": "Strong", "explanation": "The fraud analytics platform includes dashboards for investigation workflows.", "resume_evidence": "Power BI/Streamlit dashboards for suspicious transaction prioritization."},
            {"jd_requirement": "Operational monitoring", "match_strength": "Strong", "explanation": "The server monitoring system shows production-awareness.", "resume_evidence": "Go, NATS, InfluxDB, Docker metrics pipeline."},
        ],
