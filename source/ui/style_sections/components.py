# ruff: noqa: F841,F541
def component_css(tokens: dict) -> str:
    ...
    return f"""        .tf-card,
        ...
        .evidence-proof-table th,
        .evidence-proof-table td {{
            padding:12px;
